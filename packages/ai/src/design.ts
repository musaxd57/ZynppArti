...
export const DESIGN_SYSTEM = [
  ...
  'Her odaya anlamlı TÜRKÇE ad ver (Salon, Mutfak, Banyo, Antre, Ebeveyn Yatak Odası, Çocuk Odası ...);',
  '  adsız oda BIRAKMA. "X+1" istenirse X yatak odası + 1 salon kur (ör. 3+1 = 3 yatak odası + salon).',
