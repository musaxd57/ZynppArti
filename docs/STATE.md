...
- **KALAN denetim bulguları (sonraki otonom tick'ler):** engine/tools (M2 hatch build-stroke perf, M3 escape-cancel drag, M4 spurious handle-update, M23 grid extent), a11y (M15 focus-trap, M16 menu keyboard, M17 layer keyboard), ux (M19 3D dead buttons, M23 grid), + 40 LOW. Bulgu dökümü scratchpad/findings.json.
