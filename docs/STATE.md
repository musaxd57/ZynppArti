...
- **KALAN (düşük değerli kuyruk):** M17 (katman klavye sürükle/yeniden-adlandır — büyük, ayrı iş), L24 (store.byType helper — 8 dosyalık geniş refactor), L17 (Assistant hata-banner mode-scoped), L19 (ProgramBuilder boş-girdi ux), L5-benzeri 3B follow-up. Bulgu dökümü scratchpad/findings.json. **Denetimin yüksek+orta sinyalli bulgularının ~tamamı kapandı.**
